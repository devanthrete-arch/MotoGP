...
export type { CacheKey, CachePart, HostedCacheOptions, HostedCacheStats, ReadOptions } from "./kernel/cache";
...
export type { HostedClient, HostedFailure, HostedFailureReason, HostedResult, HostedSuccess } from "./kernel/result";

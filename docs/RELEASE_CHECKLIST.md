...
3. Run `npm run test`.
4. Confirm the feed, filters, saved posts, following mode, profile form, comments, reports, moderator queue, write form, subscriptions, model notebooks, garage timeline, garage insights, build loop, and feedback lane work.
